...
- **[Helm](../kubernetes-helm/index.md)** – ein Paketmanager für Kubernetes, mit dem du fertige Anwendungen aus vorgefertigten Paketen installierst, statt jedes Manifest einzeln zu schreiben. Zum Anfassen im Block [Kubernetes – Helm](../kubernetes-helm/index.md).

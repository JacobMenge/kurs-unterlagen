...
Die Verwirrung kommt daher, dass die Abkürzung **CD doppelt belegt** ist: einmal für **Delivery** und einmal für **Deployment**. Auch unter Profis ist das die häufigste Verwechslung.
...
> **Jede grüne CI-Version wird automatisch in eine releasefähige Form gebracht. Das tatsächliche Veröffentlichen geschieht aber auf Knopfdruck eines Menschen.**
...
- **Continuous Deployment** automatisiert auch das Veröffentlichen. Es braucht hohe Test-Abdeckung und gute Deployment-Strategie.
...
!!! success "Merksatz"
    > **CI = bauen und testen. Continuous Delivery = paketieren und bereitlegen. Continuous Deployment = automatisch veröffentlichen. Jede Stufe schließt die vorherige ein. Niemand muss die letzte Stufe haben.**
...
- [Grundlagen von GitHub Actions](github-actions-grundlagen.md): das konkrete Werkzeug
